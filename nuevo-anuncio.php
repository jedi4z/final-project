<?php
/**
 * Este archivo contiene la vista para dar de alta a 
 * un nuevo auncio.
 * 
 * @package vistas
 ...
 */
/**
 * Se llama al archivo funciones-usuario.php y hacemos uso de la funcion
 * segurizar() para qu solamente un usuario logueado pueda ingresar a esta
 * seccion.
 */
require_once 'Funciones/funciones-usuario.php';
segurizar();
?>
<!DOCTYPE HTML>
<html>
    <head lang="es">
        ...
        <title>Notiexpress - Nuevo anuncio</title>
        ...
        <div id="wrapper">
            ...
            <div id=container>
                ...
                <div id="row2">
                    <div id="containter-box">
                    <?php
                        require_once __DIR__ . '/Snippet/Nuevo-anuncio/nuevo-anuncio.php';
                    ?>
                    </div>
                </div>
                <div id="row3">
