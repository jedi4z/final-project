<?php
/**
 * Este archivo contiene la vista para mostrar todos los anuncios
 * realizados por el usuario logueado
 * 
 * @package vistas
...
<html>
    <head lang="es">
        ...
        <title>Notiexpress - Mis anuncios</title>
            ...
            <div id=container>
                ...
                <div id="row2">
                    <div id="containter-box">
                        <?php
                        /**
                         * Aqui llamo al Snippet mis-anuncios.php que
                         * muestra todos los anuncios publicados por el 
                         * usuario logueado.
                         */
                        require_once __DIR__ . '/Snippet/Mis-anuncios/mis-anuncios.php';
                        ?>
                    </div>
                </div>
                <div id="row3">
